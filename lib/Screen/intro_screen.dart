            ...
            child: Column(children: [
             ...
             SizedBox(height: 40,),
              ...
              Container(
                width: double.infinity,
                height: 40,
                child: ElevatedButton(onPressed: (){Navigator.of(context).pushReplacement(MaterialPageRoute(builder: (context)=>const AuthScreen()));},
                  style:btnStyle(const Color.fromARGB(255, 19, 143, 120), Colors.white), child: const Text('Join Now'),
                ),
              ),
            ]),
          ),
